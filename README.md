Requirements:  
<br>Accédez au tableau de bord "uBlock Origin/Nano Adblocker", sélectionnez ***l'onglet Paramètres***, cochez ***Activer les fonctionnalités avancées*** puis cliquez sur ***l'icône engrenages*** ⚙ qui s'affiche. Pour ***userResourcesLocation*** (tout en bas), remplacez ***unset*** par [ce fichier de scriptlets](https://raw.githubusercontent.com/K-mikaZ/new_approach_adb__1st/master/common_utils/Resources/scriptlets.js) pour que certains filtres fonctionnent.<br><br>Go to the "uBlock Origin/Nano Adblocker" dashboard, select ***the Settings tab***, check ***Activate advanced features*** then click on ***the gears icon*** ⚙ which is displayed. For ***userResourcesLocation*** (at the bottom) replace ***unset*** with [this scriptlets file](https://raw.githubusercontent.com/K-mikaZ/new_approach_adb__1st/master/common_utils/Resources/scriptlets.js) for some filters to work.  
<br>Lists:
