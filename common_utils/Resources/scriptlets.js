...
(function () {
     ...
     * ```
     *
     * - `attrs` â€” required, attribute or list of attributes joined by '|';
     * - `selector` â€” optional, CSS selector, specifies DOM nodes from which the attributes will be removed
     *
     * **Examples**
     ...
     * ```
     *
     * - `classes` â€” required, class or list of classes separated by '|';
     * - `selector` â€” optional, CSS selector, specifies DOM nodes from which the classes will be removed;
